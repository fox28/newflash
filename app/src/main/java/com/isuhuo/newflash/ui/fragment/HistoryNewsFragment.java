package com.isuhuo.newflash.ui.fragment;
...
import com.isuhuo.newflash.ui.activity.HistoryAndCollectionActivity;
import com.isuhuo.newflash.ui.activity.SearchDetailsWebActivity;
import com.isuhuo.newflash.ui.adapter.RootAdapter;
import com.isuhuo.newflash.util.Kuaibao;
import com.isuhuo.newflash.util.SpUtils;
import com.isuhuo.newflash.util.TimeUtil;
import com.isuhuo.newflash.util.UserBeen;
import com.isuhuo.newflash.widget.LoadingDialog;
...
//                listView.setAdapter(adapter);
    ...
    private void initData() {
        ...
        params.put("limit", "20");
        params.put("sign", 1+"");
        params.put("uid", SpUtils.getUser(getContext(),"id", null));// "MDAwMDAwMDAwMICdi3M"
        RequestQueue requestQueue = Volley.newRequestQueue(getContext());
