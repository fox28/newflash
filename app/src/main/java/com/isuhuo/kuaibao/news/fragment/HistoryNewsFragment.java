package com.isuhuo.kuaibao.news.fragment;
...
import com.isuhuo.kuaibao.news.HistoryNewsActivity;
import com.isuhuo.kuaibao.news.SuBaoWebActivity;
import com.isuhuo.kuaibao.news.adapter.RootAdapter;
import com.isuhuo.kuaibao.util.Kuaibao;
import com.isuhuo.kuaibao.util.TimeUtil;
...
public class HistoryNewsFragment extends Fragment {
    ...
    private Date date;
    private HistoryNewsActivity activity;
    private Map<String,String> params;
    private int shoucCode = 0;
    private int index = 0;
    private TextView bianjilsTv, quxiaolsTv,bianjiscTv, quxiaoscTv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_history_news, container, false);
        activity = (HistoryNewsActivity)getActivity();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                list_delete.clear();
                list_string.clear();
                Intent intent = new Intent(getActivity(), SuBaoWebActivity.class);
                ...
                index = position;
               /* adapter.getList().remove(position-1);
...
//                adapter = new HistoryAdapter(getContext(),list,R.layout.kuaibao_item);
//                listView.setAdapter(adapter);
                ...
                Request<JSONObject> request = new NormalPostRequest(URLMannager.Base_URL + URLMannager.Del_History,
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser){
            HistoryNewsActivity activity = (HistoryNewsActivity) getActivity();
            count = 1;
        }
    }
    @Override
    ...
    private class HistoryAdapter extends RootAdapter<Kuaibao> {
        ...
        public HistoryAdapter(Context context, List<Kuaibao> lists, int layoutId) {
