...
import com.isuhuo.kuaibao.base.BaseActivity;
import com.isuhuo.kuaibao.base.MyAppLocation;
import com.isuhuo.kuaibao.login.LoginActivity;
import com.isuhuo.kuaibao.news.adapter.FragmentAdapter;
import com.isuhuo.kuaibao.news.fragment.NewSuBaoFragment;
import com.isuhuo.kuaibao.news.fragment.NewSuBaoReFragment;
import com.isuhuo.kuaibao.news.fragment.NewSuBaoSbkkFragment;
import com.isuhuo.kuaibao.setting.SettingActivity;
import com.isuhuo.kuaibao.util.UserBeen;
import com.isuhuo.kuaibao.view.MyImageView;
import com.isuhuo.kuaibao.view.RoundImageView;
import com.isuhuo.kuaibao.view.TabStripIndicator;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, SuBaoFindActivity.class);
        ...
        list.add(new NewSuBaoFragment());
        list.add(new NewSuBaoReFragment());
        list.add(new NewSuBaoSbkkFragment());
    ...
    private View.OnClickListener headerListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.historyTv:
                    Intent intent1 = new Intent(MainActivity.this, HistoryNewsActivity.class);
                    intent1.putExtra("hors", "his");
                    MainActivity.this.startActivity(intent1);
                    break;
                case R.id.myshcTv:
                    Intent intent2 = new Intent(MainActivity.this, HistoryNewsActivity.class);
