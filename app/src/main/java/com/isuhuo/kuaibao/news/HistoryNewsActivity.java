...
import com.isuhuo.kuaibao.news.fragment.HistoryNewsFragment;
import com.isuhuo.kuaibao.news.fragment.ShouCangNewsFragment;
import com.isuhuo.kuaibao.view.TabStripIndicator;


public class HistoryNewsActivity extends AppCompatActivity {
    ...
    private ShouCangNewsFragment fragment2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hors = intent.getStringExtra("hors");
        ...
        fragment2 = new ShouCangNewsFragment();
        list.add(fragment2);
        list.add(fragment1);
