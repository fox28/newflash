...
import com.isuhuo.kuaibao.news.MainActivity;
...
public class NewSuBaoFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_new_su_bao, container, false);
            ...
            if(jsonObj1.getString("status").equals("success")) {
                ...
                if(array1.length()>0) {
                    for (int i = 0; i < array1.length(); i++) {
                        ...
                        kuaibao.collect_status = array1_2.getString("collect_status");
                        list.add(kuaibao);
                    }
                }else {
